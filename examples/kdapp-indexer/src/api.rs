...
#[derive(serde::Deserialize)]
pub struct MeQueryQS { pub id: Option<u64>, pub pubkey: Option<String> }

pub async fn me_qs(axum::extract::State(store): axum::extract::State<Store>, Query(q): Query<MeQueryQS>) -> Result<Json<MeResp>, StatusCode> {
