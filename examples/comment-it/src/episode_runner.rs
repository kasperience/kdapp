...
// REMOVED: COMMENT_PATTERN and COMMENT_PREFIX
// Now using unified AUTH_PATTERN and AUTH_PREFIX for all unified episode commands
...
// REMOVED: CommentEventHandler
// Now integrated into unified AuthEventHandler
